      ...
      <div className="member-view-wrapper">
        <div className="common-db-head mb-4">
          <Row className="align-items-center">
            ...
            <IsAccessibleMethod
              method={Object.keys(PermissionSets.staff.Department.Create)[0]}
                  ...
                  {departmentList?.data?.results?.map((each) => {
                    return (
                      <tr>
                        ...
                        <td className="dep-code">{each?.code}</td>
                        <td className="dep-name">{each?.name}</td>
                        {/* <td>
                        ...
                        <IsAccessibleMethod
                          method={Object.keys(PermissionSets.staff.Department.Update)[0]}
                          route={window.location.pathname}
                          >
                        ...
                        <IsAccessibleMethod
                          method={Object.keys(PermissionSets.staff.Department.Delete)[0]}
                          route={window.location.pathname}
                        >
                          <td className="actions">
                            <Button
