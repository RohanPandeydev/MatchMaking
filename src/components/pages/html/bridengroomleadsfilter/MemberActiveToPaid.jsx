...
const MemberActiveToPaid = () => {
  ...
  return (
    <>
      {
    <div className="view-profile-wrapper member-active-to-paid-wrapper">
                    ...
                    <div className="view-profile-content">
                        ...
                        <div className="profile-details-wrap">
                            ...
                            <Row>
                                ...
                                <div className="profile-name-wrap">
                                    ...
                                    <Button className="btn blue-btn me-2 mb-2">Paid</Button>
                                ...
                                <Col md="12" lg="12" xl="6" xxl="3" className="mb-3 mb-xxl-0">
                                <div className="profile-status-wrap">
                                    <p><span>Next Followup :</span> N/A</p>
                                    <p><span>Registered On :</span> November 25, 2019
                                    12:24 PM</p>
                                    <p><span>Assigned To : </span> Baldev Cheema</p>
                                </div>
                                </Col>
                            </Row>
                            </div>
                        ...
                        <div className="profile-button-wrap">
                            <div className="upgrade-plan-btn">
                                ...
                                <div className="renew-pack-btn">
                                    <Button className="btn yellow-btn"> Approve As Paid   </Button>
                                </div>
                            </div>
...
export default MemberActiveToPaid
