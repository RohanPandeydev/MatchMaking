                        ...
                        <div className="profile-details-bottom">
                            ...
                            <div className="profile-org-franchise-wrap">
                                ...
                                <div className="profile-org-franchise-list-wrap">
                                    <ul>
                                        <li>Franchise Name 1</li>
                                        <li>Franchise Name 2</li>
                                        <li>Franchise Name 3</li>
                                        <li>Franchise Name 4</li>
                                        <li>Franchise Name 5</li>
                                    </ul>
                                </div>
                            </div>
                            <div className="profile-org-franchise-wrap border-top-0">
                                ...
                                <div className="profile-org-franchise-list-wrap">
                                    <ul>
                                        <li>Organization Name 1</li>
                                        <li>Organization Name 2</li>
                                        <li>Organization Name 3</li>
                                        <li>Organization Name 4</li>
                                        <li>Organization Name 5</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
