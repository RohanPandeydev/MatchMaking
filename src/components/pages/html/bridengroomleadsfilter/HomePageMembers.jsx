...
import { FaMinus, FaPlus, FaRegComments } from "react-icons/fa";
            ...
            <div className="d-flex flex-wrap">
                <div className="profile-headleft">
                    ...
                    <li className="assign-staff-btn">
                        <Button className="btn green-btn"><FaPlus /> Add to Home Page </Button>
                    </li>
                    <li className="unassign-staff-btn">
                        <Button className="btn btn-outline-style1">
                        <FaMinus /> Remove from Home Page
                        </Button>
                    </li>
                    <li className="active-member-dropdown">
                        <Input id="" name="" type="select">
                            <option>Select Interest</option>
                            <option>Active (21005)</option>
                            <option>All (1115)</option>
                        </Input>
                    </li>
