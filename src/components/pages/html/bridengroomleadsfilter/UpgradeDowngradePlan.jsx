...
const UpgradeDowngradePlan = () => {
  ...
  return (
    <>
      {
    <div className="view-profile-wrapper upgrade-downgrade-plan-wrapper">
                    ...
                    <div className="profile-button-wrap">
                        <div className="upgrade-plan-btn">
                            ...
                            <div className="renew-pack-btn">
                                <Button className="btn green-btn"> Renew Member  </Button>
                                <Button className="btn blue-btn"> Add on Pack  </Button>
                            </div>
                        </div>
