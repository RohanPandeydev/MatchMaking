                ...
                <div className="profile-headleft">
                    <ul>
                        ...
                        <li className="active-member-dropdown">
                            <Input id="" name="" type="select">
                                <option>Nri Prime (33)</option>
                                <option>Nri Superior Plus (168)</option>
                                <option>Platinum  (56)</option>
                                <option>Nri Superior Max (0)</option>
                                <option>Diamond Plus (18)</option>
                                <option>Nri Superior Elite  (336)</option>
                                <option>Free (25)</option>
...
export default PlanwisePaidMembers
