...
import ConvertOrganizationImg from "../../../../assets/images/convert-organization.svg";
import { LiaExchangeAltSolid } from "react-icons/lia";
const ConvertToFranchise = ({
  toggleModel,
  handleToggleModel,
  setToggleModel,
  setModelData,
  ...
  const submitHandler = (data) => {
    ...
    memberFranchiseUpdate.mutate(data);
  };

  const handleReset = () => {
    queryClient.refetchQueries(["member-organization", pageNumber]);
    setModelData({});
  };
  ...
  const memberFranchiseUpdate = useMutation(
    (data) => MemberServices.ConversionOrganizationToFranchise(data),
    {
      onSuccess: (data) => {
        ...
        Swal.fire({
          title: "Successfull",
          text: "Account has been converted to franchise successfully",
          icon: "success",
        });
        handleCloseModel();
          ...
          <Row className="mt-2">
            ...
            <Col xs="12" md="12" lg="12" className="text-center">
              <Button
                ...
                type="submit"
                disabled={memberFranchiseUpdate?.isLoading}
              >
                {memberFranchiseUpdate?.isLoading ? (
                  <ButtonLoader />
                ) : (
                  <>
                    Organization <IoArrowForwardSharp /> Franchise
                  </>
                )}
              </Button>
            </Col>
...
export default ConvertToFranchise;
