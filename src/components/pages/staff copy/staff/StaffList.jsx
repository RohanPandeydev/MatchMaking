        ...
        <Row>
          ...
          <Col xs="12" lg="6">
            <ul className="common-head-list justify-content-lg-end">
              ...
              <IsAccessibleMethod
                methodName={PermissionSets?.staff?.StaffList?.Create}
                ...
                <Row>
                    ...
                    <Row>
                      <Col xl="6" className="mb-4">
                        <div className="staff-details-list-wrap">
                          ...
                          {/* <div className="staff-details-list">
                            <div className="name">Mobile For Password:</div>
                            <div className="info">9999999999</div>
                          </div> */}
                          {/* <div className="staff-details-list">
                            <div className="name">Extension:</div>
                            <div className="info">1</div>
                          </div> */}
                          {/* <div className="staff-details-list">
                            <div className="name">Is Online:</div>
                            <div className="info">172.68.79.150</div>
                          </div> */}
                        </div>
                      </Col>
                      <Col xl="6" className="mb-4">
                        <div className="staff-details-list-wrap">
                          ...
                          {each?.department?.permissions?.length > 0 &&
                            each?.department?.permissions?.map((module) => {
                              console.log(module, "---");
                              return (
                                <div className="staff-details-list">
                                  <div className="name">
                                    ...
                                    <div className="staff-subscription-write">
                                      {module?.children?.map((child) => (
                                        <div className="staff-subscription-write">
                                          ...
                                          {child?.methods?.length &&
                                            child?.methods?.map((method) => {
                                              return (
                                                // <div className="staff-subscription-write">
                                                <span className="child-permission">{method?.label}</span>
                                                // </div>
                                              );
                                            })}
                                        </div>
                  ...
                  <Col xs="12" lg="4" xl="3" xxl="3">
                    <div className="staff-right-btn">
                      <ul>
                        <IsAccessibleMethod
                          methodName={PermissionSets?.staff?.StaffList?.Delete}
                          pathname={window.location.pathname}
                        >
                          <li>
                            <Button
                        ...
                        <IsAccessibleMethod
                          methodName={PermissionSets?.staff?.StaffList?.Update}
                          pathname={window.location.pathname}
                        >
                          <li>
                            <Button
