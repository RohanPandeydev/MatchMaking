...
const Looking = () => {
  ...
  const deleteMutation = useDeleteMasterContent("all-lang-list-looking");
  const updateMutation = useUpdateContent("all-lang-list-looking");

  const lookingForOptions = [
    { id: 1, lookingFor: "Marriage" },
    { id: 2, lookingFor: "Long-Term Relationship" },
    { id: 3, lookingFor: "Short-Term Relationship" },
    { id: 4, lookingFor: "Friendship" },
    { id: 5, lookingFor: "Casual Dating" },
    { id: 6, lookingFor: "Companionship" },
    { id: 7, lookingFor: "Networking" },
    { id: 8, lookingFor: "Mentorship" },
    { id: 9, lookingFor: "Partnership" },
    { id: 10, lookingFor: "Professional Connections" },
  ];
  const columns = [
    {
      name: "Sl No.",
          ...
          <div className="master-action-btn-wrap">
            ...
            >
              <Button
                ...
                onClick={() => nav("/master/lookingfor/add/" + btoa(row?.id))}
              >
                {" "}
                <FaEdit />{" "}
              </Button>
  ...
  const { data, isLoading } = useFetchMasterSectionData(url, "all-lang-list-looking", search)
