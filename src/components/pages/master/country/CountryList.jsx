...
const CountryList = () => {
          ...
          <div className="master-action-btn-wrap">
            ...
            >
              <Button
                ...
                onClick={() => nav("/master/country/add/" + btoa(row?.id))}
              >
                {" "}
                <FaEdit />{" "}
              </Button>
  ...
  const { data, isLoading } = useQuery(
    ["all-country-list", search, pageNumber],
    () => {
      let queryParams = [];
      ...
      return MasterServices.getCountryList(queryString)
    },
    {
  ...
  const deleteMutation = useMutation(
    (formdata) => MasterServices.getCountryDeleteById(formdata),
    {
      onSuccess: () => {
        Swal.fire({
          title: "Successful",
