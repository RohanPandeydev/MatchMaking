...
const EmployedIn = () => {
  ...
  const deleteMutation = useDeleteMasterContent("all-lang-list-employed");
  const updateMutation = useUpdateContent("all-lang-list-employed");
          ...
          <div className="master-action-btn-wrap">
            ...
            >
              <Button
                ...
                onClick={() => nav("/master/employedin/add/" + btoa(row?.id))}
              >
                {" "}
                <FaEdit />{" "}
              </Button>
  ...
  const handleNav = () => {
    nav("/master/employedin/add");
  };
  // const { data, isLoading } = useQuery(
  //   ["all-lang-list-employed"],
  ...
  const { data, isLoading } = useFetchMasterSectionData(url, "all-lang-list-employed", search)
