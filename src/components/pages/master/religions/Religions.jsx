...
const Religions = () => {
  ...
  const religions = [
    ...
    { id: 5, name: "Buddhism" },
    { id: 6, name: "Jainism" },
    { id: 7, name: "Zoroastrianism" },
    { id: 8, name: "Judaism" },
    { id: 9, name: "Bahá'í" },
    { id: 10, name: "Confucianism" },
  ];
  const nav = useNavigate();
  const deleteMutation = useDeleteMasterContent("all-lang-list-religion");
  const updateMutation = useUpdateContent("all-lang-list-religion");
          ...
          <div className="master-action-btn-wrap">
            ...
            >
              <Button
                ...
                onClick={() => nav("/master/religions/add/" + btoa(row?.id))}
              >
                {" "}
                <FaEdit />{" "}
              </Button>
  ...
  const handleNav = () => {
    nav("/master/religions/add");
  };

  // const { data, isLoading } = useQuery(
  //   ["all-lang-list-religion"],
  ...
  const { data, isLoading } = useFetchMasterSectionData(url, "all-lang-list-religion", search)
