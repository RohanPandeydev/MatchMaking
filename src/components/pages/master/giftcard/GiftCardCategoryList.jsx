...
const GiftCardCategoryList = () => {
    const url = getValueBetweenMasterAndAdd(window.location.href);
    const nav = useNavigate();
    const deleteMutation = useDeleteMasterContent("all-giftcard-category-list");
    const updateMutation = useUpdateContent("all-giftcard-category-list");
                    ...
                    <div className="master-action-btn-wrap">
                        ...
                        >
                            <Button
                                ...
                                onClick={() => nav("/master/giftcardcategory/add/" + btoa(row?.id))}
                            >
                                {" "}
                                <FaEdit />{" "}
                            </Button>
    ...
    const handleNav = () => {
        nav("/master/giftcardcategory/add");
    };
    ...
    const { data, isLoading } = useFetchMasterSectionData(url, "all-giftcard-category-list", search)
...
export default GiftCardCategoryList;
