...
const MatchedProfileListing = ({handleOffCanvas,matchProfileListing,initialLimit}) => {
  return (
    <>
  {matchProfileListing?.results?.length==0?<NoActiveDataFound msg={"No matching profile found"} /> :matchProfileListing?.results?.map((each)=>{
    return  <div className="match-profile-list">
...
export default MatchedProfileListing